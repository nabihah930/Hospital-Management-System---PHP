...
<!DOCTYPE html>
    <head>
        ...
        <title>
            "NewLife Hospital-Book a Routine check up"</title>
		    <link rel="stylesheet" href="style.css" />
    </head>
    <body>
        <h1>Booking a Routine Appointment</h1>
        <h3>
        <?php
                ...
                try {
                    ...
                    if(CDP($id_result['dept_id'])){                                         #for cardiology department
                        ...
                        if($clash_result && $statement5->rowCount() > 0){                   #there may be clashes
                            ...
                            $get_duration = "SELECT * FROM appointment_info WHERE appointment_type = 'ROU02'";
                            ...
                            #all slots are free
                            $book_appointment = "SELECT duration, charges FROM appointment_info WHERE appointment_type = 'ROU02'";
