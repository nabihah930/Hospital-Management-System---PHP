                ...
                try {
                    ...
                    if(CDP($id_result['dept_id'])){                                         #for cardiology department
                        ...
                        if($clash_result && $statement5->rowCount() > 0){                   #there may be clashes
                            ...
                            $get_duration = "SELECT * FROM appointment_info WHERE appointment_type = 'CON03'";
                            ...
                            #all slots are free
                            $book_appointment = "SELECT duration, charges FROM appointment_info WHERE appointment_type = 'CON03'";
